...
// doba produktowa 6:00 → 6:00 — definicja wspólna z Zawodnikami: patrz lib/doba.ts
...
/**
 * ⚑ PÓŁKA Z BACKENDU MA PIERWSZEŃSTWO (2026-09-15). Limit doby to 15 typów
 * „wysokiej szansy" (drużyny: kurs do 1,45) i 5 „wyższych kursów" (1,80–2,00)
 * — sekcje strony muszą dzielić dokładnie tak, inaczej „częściej wchodzą"
 * mieszałoby obie półki. Próg kursu zostaje dla typów sprzed półek (bez pola).
 */
        ...
        lista.length >= PROG_POLEK && pewne.length > 0 && odwazne.length > 0
          ? [
              ...
              // nieprawdziwy; tego pilnujemy w całym produkcie.
              {
                ...
                opis: "Niższe kursy. Wygrana jest mniejsza, ale takie typy wchodzą regularnie – z nich składamy kupony.",
                typy: pewne,
              },
              {
                nazwa: "więcej płacą",
                opis: "Wyższe kursy. Wchodzą rzadziej, ale gdy wejdą, wygrana jest wyraźnie większa.",
                typy: odwazne,
              },
            ]
